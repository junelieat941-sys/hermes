...
DARK   = (12, 14, 18)     # deep cool-dark (LOOP-style)
MID    = (42, 44, 52)     # slightly lighter cool-dark
ACCENT = (120, 210, 255)  # icy blue accent (matching LOOP)
SOFT   = (230, 235, 240)  # for subtle accents
WHITE  = (255, 255, 255)
...
hero_src = load_hero(f"{ASSETS}/v3_hero.jpg")
...
draw.text((118, 88), "COOL · DARK VIBES", font=kicker_font, fill=SOFT)

# ---- big title ----
title_font = font(SERIF_BOLD, 190)
draw.text((62, 148), "流光", font=title_font, fill=WHITE)
en_font = font(SANS_BOLD, 78)
draw.text((68, 392), "RADIANCE", font=en_font, fill=ACCENT)
...
draw.text((68, 516), "冷冽暗夜 · 光影流动", font=tag_font, fill=SOFT)
...
draw.text((68, 570), "from the dark", font=tag2_font, fill=SOFT)
_tb = draw.textbbox((0, 0), "from the dark", font=tag2_font)
...
out = f"{ASSETS}/cover_v3.png"
canvas.save(out, "PNG")
canvas.convert("RGB").save(f"{ASSETS}/cover_v3.jpg", "JPEG", quality=92)
